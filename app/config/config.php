...
defined('DATABASE_DB_NAME')         ? null : define ('DATABASE_DB_NAME', 'poo_store');
...
defined('PRODUCTS_IMAGES_UPLOAD_STORAGE')    ? null : define ('PRODUCTS_IMAGES_UPLOAD_STORAGE', IMAGES_UPLOAD_STORAGE . DS . 'products');
defined('CATEGORIES_IMAGES_UPLOAD_STORAGE')  ? null : define ('CATEGORIES_IMAGES_UPLOAD_STORAGE', IMAGES_UPLOAD_STORAGE . DS . 'categories');
defined('PROFILES_IMAGES_UPLOAD_STORAGE')  ? null : define ('PROFILES_IMAGES_UPLOAD_STORAGE', IMAGES_UPLOAD_STORAGE . DS . 'profiles');
