<ul class="breadcrumb">
    ...
    <li><a href="/expensescategories/create"><?= @$title ?></a></li>
</ul>
            ...
            <form autocomplete="off" class="form-horizontal" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="form-control" required="required" type="text" name="ExpenseName" id="ExpenseName"
                                   maxlength="30" value="<?= $this->showValue('ExpenseName') ?>">
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="form-control" type="number" required="required" step="0.01" min="1"  name="FixedPayment"
                                   max='9999999' id="FixedPayment" value="<?= $this->showValue('FixedPayment') ?>">
                        </div>
