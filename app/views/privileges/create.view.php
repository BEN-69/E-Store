<ul class="breadcrumb">
    ...
    <li>
        <a href="/privileges"><?= $title_base ?></a>
        <i class="icon-angle-right"></i>
    </li>
            ...
            <form autocomplete="off" class="form-horizontal" method="post" enctype="application/x-www-form-urlencoded">
                <fieldset>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="form-control" required="required" type="text" name="PrivilegeTitle" id="PrivilegeTitle" maxlength="30">
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="form-control" required="required" type="text" name="Privilege" id="Privilege" maxlength="30">
                        </div>
