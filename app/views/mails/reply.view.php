<ul class="breadcrumb">
    ...
    <li><a href="/mails/relpy"><?= @$title ?></a></li>
</ul>
            ...
            <form autocomplete="off" class="form-horizontal" method="post" enctype="application/x-www-form-urlencoded">
                <fieldset>
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" class="form-control" id="Title" name="Title" required="required"
                                   value="<?= $this->showValue('Title',$mail) ?>" maxlength="30"/>
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <textarea class="cleditor" autofocus required name="Content" id="Content" cols="30" maxlength="255" rows="10">
                                &#10;----------------------------------------------------------&#10;
                                <?= $this->showValue('Content',$mail) ?>
                            </textarea>
                        </div>
                    </div>
