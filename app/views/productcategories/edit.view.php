<ul class="breadcrumb">
    ...
    <li><a href="/productcategories/edit/<?= $productcategories->CategoryId ?>"><?= @$title ?></a></li>
</ul>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="form-control" required="required" type="text" name="Name" id="Name"
                                   maxlength="40" value="<?= $this->showValue('Name',$productcategories) ?>">
                        </div>

                    </div>

                    <?php if($productcategories->Image !='') : ?>
                    <div class="control-group">
                        <div class="controls">
                            <img src="/uploads/images/categories/<?= $productcategories->Image ?>" alt="image category" width="30%">
                        </div>
                    </div>
                    <?php endif; ?>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="form-control"  type="file" name="Image" id="Image"
                                   maxlength="40" accept="image/*" value="<?= $this->showValue('Image',$productcategories) ?>">
                        </div>
