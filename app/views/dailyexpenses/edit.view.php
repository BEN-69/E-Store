        ...
        <div class="contentBox clearfix">
            <form id="client_form" action="" class="appForm" method="post">
                <table>
                        ...
                        <td>
                            <select name="categoryId" id="categoryId">
                                ...
                                <?php if (false !== $categories): foreach ($categories as $category): ?>
                                    <option value="<?= $category->id ?>" <?= $this->selectedIf('categoryId', $category->id, $expense) ?>><?= $category->name ?></option>
                    ...
                    <tr>
                        <td>
                            <input type="number" step="0.01" min="1" id="payment" name="payment" value="<?= $this->showValue('payment', $expense) ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr>
                        <td>
                            <input required type="text" id="description" name="description" value="<?= $this->showValue('description', $expense) ?>" />
                        </td>
                    </tr>
                    <tr>
                        <td>
