<ul class="breadcrumb">
    ...
    <li>
        <a href="/suppliers"><?= $title_base ?></a>
        <i class="icon-angle-right"></i>
    </li>
    <li><a href="/suppliers/edit/<?= $supplier->SupplierId ?>"><?= @$title ?></a></li>
</ul>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="form-control" required="required" type="text" name="Name" id="Name"
                                       maxlength="40" value="<?= $this->showValue('Name',$supplier) ?>">
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="form-control" required="required" type="text" name="Email" id="Email"
                                       maxlength="40" value="<?= $this->showValue('Email',$supplier) ?>">
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="form-control" required="required" type="text" name="PhoneNumber" id="PhoneNumber"
                                       maxlength="40" value="<?= $this->showValue('PhoneNumber',$supplier) ?>">
                            </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input class="form-control" required="required" type="text" name="Address" id="Address"
                                       maxlength="40" value="<?= $this->showValue('Address',$supplier) ?>">
                            </div>
