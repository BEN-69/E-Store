<ul class="breadcrumb">
    ...
    <li><a href="/suppliers/create"><?= @$title ?></a></li>
</ul>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="form-control" required="required" type="text" name="Name" id="Name"
                                   maxlength="40" value="<?= $this->showValue('Name') ?>">
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="form-control" required="required" type="text" name="Email" id="Email"
                                   maxlength="40" value="<?= $this->showValue('Email') ?>">
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="form-control" required="required" type="text" name="PhoneNumber" id="PhoneNumber"
                                   maxlength="40" value="<?= $this->showValue('PhoneNumber') ?>">
                        </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input class="form-control" required="required" type="text" name="Address" id="Address"
                                   maxlength="40" value="<?= $this->showValue('Address') ?>">
                        </div>
